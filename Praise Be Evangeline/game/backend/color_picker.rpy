...
init 499 image selector_img = construct_selector(2, 3)
init 499 image selector_bg = Frame("selector_img", 7, 7)

init 499 image selector = Transform("selector_bg", xysize=(15, 15))

init -1 style picker_hexcode:
    color "#fff"
    font "DejaVuSans.ttf"
